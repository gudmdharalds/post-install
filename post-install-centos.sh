...
yum install -y vim nano acpid whois net-tools telnet epel-release keepass firefox pidgin hexchat thunderbird rsync xterm php yum-cron mutt git unzip zip tcpdump subversion dos2unix acpid jwhois && \
